...
from unicorns import HELP, TEMP_SETTINGS
...
@unicorn(pattern='^.reserved$', compat=False)
...
@unicorn(pattern='^.name', compat=False)
...
@unicorn(pattern='^.setpfp$', compat=False)
...
@unicorn(pattern='^.delpfp', compat=False)
...
@unicorn(pattern='^.setbio', compat=False)
...
@unicorn(pattern='^.username', compat=False)
...
@unicorn(pattern='^.block$', compat=False)
...
@unicorn(pattern='^.unblock$', compat=False)
...
@unicorn(pattern='^.online', compat=False)
...
@unicorn(pattern='^.stats$', compat=False)
