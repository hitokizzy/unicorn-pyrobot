...
from unicorns import DRIVE_CLIENT, DRIVE_SECRET, GDRIVE_FOLDER_ID, HELP
...
from geezram.sql.gdrive_sql import get, remove_, set
...
class Gdrive:
    ...
    def download_link(self, url):
        try:
            ...
            return edit(self.message, f"An Error Encountered")
...
def drive_upload(message):
    ...
    if reply and reply.document:
        ...
        if not args.startswith("https://" or "http://"):
            return edit(message, f"`URL is invalid.`")
