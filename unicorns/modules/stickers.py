...
from unicorns import HELP, PACKNAME, PACKNICK, TEMP_SETTINGS
...
@unicorn(pattern='^.(d[ıi]zla|kang)', compat=False)
...
@unicorn(pattern='.packinfo$', compat=False)
