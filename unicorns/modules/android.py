...
from geezram.core import edit, extract_args, get_translation, unicorn, use_proxy


@unicorn(pattern='^.magisk$')
def magisk(message):
    magisk_dict = {
...
@unicorn(pattern='^.o(range|)f(ox|rp)')
def ofox(message):
