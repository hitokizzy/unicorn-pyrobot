...
from unicorns import BRAIN, HELP
...
@unicorn(pattern='^.ban', private=False, admin=True)
...
@unicorn(pattern='^.unban', private=False, admin=True)
...
@unicorn(pattern='^.kick', private=False, admin=True)
...
@unicorn(pattern='^.mute', private=False, admin=True)
def mute_user(message):
    try:
        from geezram.sql import mute_sql as sql
    except BaseException:
    ...
    for user in find_user:
        ...
        try:
            ...
            if sql.is_muted(chat.id, user.id):
                return edit(message, 'User muted')
...
@unicorn(pattern='^.unmute', private=False, admin=True)
...
@unicorn(pattern='^.promote', admin=True, private=False, compat=False)
...
@unicorn(pattern='^.demote', private=False, admin=True)
...
@unicorn(pattern='^.pin', private=False, admin=True)
...
@unicorn(pattern='^.unpin', private=False, admin=True)
...
@unicorn(pattern='^.(admins|bots|user(s|sdel))$', compat=False, private=False)
...
@unicorn(pattern='^.zombies', private=False, compat=False)
...
@unicorn(pattern='^.setgpic$', admin=True, private=False)
...
@unicorn(incoming=True, outgoing=False)
